...
public class InputManager : MonoBehaviour
{
    ...
    [Header("SwitchYinYang Input")]
    [Tooltip("The state of the switch button")]
    public float switchButton = 0;

    /// <summary>
    /// Description:
    /// Collects switch button input
    /// Input: 
    /// CallbackContext callbackContext
    /// Returns:
    /// void (no return)
    /// </summary>
    /// <param name="callbackContext">The context of the switch input</param>
    public void GetSwitchInput(InputAction.CallbackContext callbackContext)
    {
        switchButton = callbackContext.ReadValue<float>();
    }

    [Header("Restart Input")]
    [Tooltip("The state of the restart button")]
    public float restartButton = 0;

    /// <summary>
    /// Description:
    /// Collects restart button input
    /// Input: 
    /// CallbackContext callbackContext
    /// Returns:
    /// void (no return)
    /// </summary>
    /// <param name="callbackContext">The context of the switch input</param>
    public void GetRestartInput(InputAction.CallbackContext callbackContext)
    {
        restartButton = callbackContext.ReadValue<float>();
    }
